...
house.add(roof)
// 2.5 hauteur de la maison, 0.75 correspond à la moitié de la valeur donné pour le roof
...
door.position.y = 1
door.position.z = 2 + 0.01 // +0.01 pour éviter le z-fighting contre le mur
house.add(door)
...
// on peut utiliser setScalar lorsque les valeurs sont identiques (ex: bush1.scale.set(0.5, 0.5, 0.5 => bush1.scale.setScalar(0.5)
...
// Mappings
// Pour optimiser les ombres et de nous assurer que les cartes d'ombres s'adaptent bien à la scène.
 ...
 */
const sky = new Sky()
//pour changer la taille du ciel
